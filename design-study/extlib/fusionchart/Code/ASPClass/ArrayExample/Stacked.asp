...
<html>
    <head>
        ...
        <title>FusionCharts XT - ASP Class Example-Plotting Stacked Chart from data contained in Array</title>
        ...
        <div id="wrapper">
            ...
            <div class="content-area">
                <div id="content-area-inner-main">
                    <p class="text" align="center">Plotting Stacked Chart from data contained in Array</p>
					<p>&nbsp;</p>

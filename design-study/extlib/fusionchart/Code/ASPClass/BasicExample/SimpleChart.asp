...
<html>
    <head>
        <title>FusionCharts XT - ASP Class Array Example using Simple Column 3D Chart using dataURL method</title>
        ...
        <div id="wrapper">
            ...
            <div class="content-area">
                <div id="content-area-inner-main">
                    <p class="text" align="center">Plotting simple Column 3D Chart using dataURL method</p>
					<p>&nbsp;</p>

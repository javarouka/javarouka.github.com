<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Detailed.aspx.vb" Inherits="DBExample_Detailed" %>
...
<body>
    ...
    <div id="wrapper">
        <div id="header">
            ...
            <h1 class="logo-text">
                FusionCharts Database and Drill-Down Example</h1>
        </div>
        <div class="content-area">
            <div id="content-area-inner-main">
                <h2 class="headline">
                    Detailed report for the factory</h2>
                <div class="gen-chart-render">
                    <asp:Literal ID="Literal1" runat="server"></asp:Literal>
                    <br />
                    <a class="qua qua-button" style="margin-left: 360px" href="Default.aspx?animate=0"><span>
                        Back to Summary</span></a>
                </div>
                <div class="clear">
                </div>
                <p>&nbsp;

<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Chart.aspx.vb" Inherits="FormBased_Chart" EnableViewStateMac="False"%>
...
<body>
    ...
    <div id="wrapper">
        <div id="header">
            ...
            <h1 class="logo-text">
                FusionCharts ASP.NET(VB) Form-Based Samples</h1>
        </div>

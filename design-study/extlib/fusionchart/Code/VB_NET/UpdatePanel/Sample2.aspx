...
<html>
<head>
    <title>FusionCharts Examples - Using ASP.NET.AJAX UpdatePanel</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="header">
            ...
            <h1 class="logo-text">Using ASP.NET(VB) Update Panel</h1>
        </div>
                    ...
                    <table width="890" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <div style="position:relative;">
                                <asp:UpdateProgress ID="UpdateProgress2" runat="server" DisplayAfter="1" style="position:absolute; top:145px;left:204px;">
                                    <ProgressTemplate>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManagedPrint.aspx.vb" Inherits="BasicExample_ManagedPrint" %>
    ...
    <div id="wrapper">
            ...
            <div id="header">
               ...
               <div class="logo"><a class="imagelink"  href="http://www.fusioncharts.com/" target="_blank"><img src="../assets/ui/images/fusionchartsv3.2-logo.png" width="131" height="75" alt="FusionCharts XT logo" /></a></div>
                ...
                <h1 class="logo-text">FusionCharts - ASP.NET(VB) Samples</h1>
            </div>

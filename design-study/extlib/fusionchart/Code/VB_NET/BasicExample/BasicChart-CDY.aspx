<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BasicChart-CDY.aspx.vb" Inherits="BasicChartCDY" %>
...
<body>
    ...
    <div id="wrapper">
        <div id="header">
            ...
            <h1 class="logo-text">ASP.NET(VB) Basic Examples</h1>
        </div>
        <div class="content-area">
            <div id="content-area-inner-main">
                <p class="text" align="center">The chart below shows a very basic dual Y Axis combination chart using pre-built XML from CSYData.xml</p>

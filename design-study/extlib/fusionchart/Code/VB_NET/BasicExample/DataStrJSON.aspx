<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DataStrJSON.aspx.vb" Inherits="BasicExample_DataStrJSON" %>
    ...
    <div id="wrapper">
        ...
        <div class="content-area">
            <div id="content-area-inner-main">
                <h2 class="headline">
                    Basic example using dataStr method (with JSON data hard-coded in VB.NET page itself)</h2>

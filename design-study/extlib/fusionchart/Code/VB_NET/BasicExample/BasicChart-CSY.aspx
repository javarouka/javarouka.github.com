<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BasicChart-CSY.aspx.vb" Inherits="BasicChartCSY" %>
    ...
    <div id="wrapper">
        ...
        <div class="content-area">
            <div id="content-area-inner-main">
                <p class="text" align="center">The chart below shows a very basic combination chart using pre-built XML from CSYData.xml</p>

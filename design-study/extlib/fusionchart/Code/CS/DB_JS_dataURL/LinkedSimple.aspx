<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkedSimple.aspx.cs" Inherits="DB_JS_dataURL_LinkedSimple" %>
    ...
    <center>
        ...
        <div id="wrapper">
            <div id="header">
                ...
                <h1 class="logo-text">
                    FusionCharts Database and Linked charts</h1>
            </div>
            <div class="content-area">
                <div id="content-area-inner-main">
                    <h2 class="headline">
                        Click on any pie slice to open linked chart</h2>

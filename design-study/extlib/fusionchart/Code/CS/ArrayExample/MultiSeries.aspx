<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultiSeries.aspx.cs" Inherits="ArrayExample_Default" %>
...
<body>
    ...
    <div id="wrapper">
        <div id="header">
            ...
            <h1 class="logo-text">
                ASP.NET(C#) Array Examples</h1>
        </div>
        <div class="content-area">
            <div id="content-area-inner-main">
                <h2 class="headline">
                    Plotting multi-series chart from data contained in Array.</h2>

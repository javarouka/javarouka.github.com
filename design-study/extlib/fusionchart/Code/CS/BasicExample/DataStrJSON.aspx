<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataStrJSON.aspx.cs" Inherits="BasicExample_dataStrJSON" %>
    ...
    <div id="wrapper">
        ...
        <div class="content-area">
            <div id="content-area-inner-main">
                <h2 class="headline">
                    Basic example using pre-built JSON data</h2>

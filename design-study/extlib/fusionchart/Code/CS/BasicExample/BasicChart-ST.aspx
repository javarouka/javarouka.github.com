<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BasicChart-ST.aspx.cs" Inherits="BasicExample_BasicChartST" %>
    ...
    <div id="wrapper">
        ...
        <div class="content-area">
            <div id="content-area-inner-main">
                <p class="text">The chart below shows a very basic stacked column 3D chart using pre-built XML from MSData.xml</p>

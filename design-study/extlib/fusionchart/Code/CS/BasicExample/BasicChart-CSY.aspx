<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BasicChart-CSY.aspx.cs" Inherits="BasicExample_BasicChartCSY" %>
    ...
    <div id="wrapper">
        ...
        <div class="content-area">
            <div id="content-area-inner-main">
                <p class="text">The chart below shows a very basic combination chart using pre-built XML from CSYData.xml</p>

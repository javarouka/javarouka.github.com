<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultiChartsJS.aspx.cs" Inherits="BasicExample_MultiChartsJS" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>FusionCharts - Multiple JavaScript charts on same page</title>
    ...
    <div id="wrapper">
        ...
        <div class="content-area">
            <div id="content-area-inner-main">
                <h2 class="headline">
                    Multiple Charts on the same page. Each chart has a unique ID.</h2>

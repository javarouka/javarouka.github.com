...
<body>
    ...
    <div id="wrapper">
        <div id="header">
            ...
            <h1 class="logo-text">
                ASP.NET(C#) Form-Based Examples</h1>
        </div>
        <div class="content-area">
            <div id="content-area-inner-main">
                ...
                <p class='small'>
                     Click on any pie slice to see slicing effect. Or, right click on chart and choose "Enable Rotation", and then drag and rotate the chart.</p>

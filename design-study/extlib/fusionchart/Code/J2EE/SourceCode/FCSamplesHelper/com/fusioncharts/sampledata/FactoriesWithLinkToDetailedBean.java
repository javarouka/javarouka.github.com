 ...
 * 
 */
public class FactoriesWithLinkToDetailedBean {
	...
	public FactoriesWithLinkToDetailedBean() {
	}
	...
	private String getFactoryXML() {
		...
		try {
			...
			while (rs1.next()) {
				...
				String strDataURL = FusionChartsHelper.encodeDataURL(
						"Detailed.jsp?factoryId=" + factoryId, false);

...
<% 
pageContext.setAttribute("areaChart",ChartType.AREA2D.getFileName());
...
<tags:template2>
<fc:render chartId="${chartData.chartId}" swfFilename="${folderPath}${chartData.swfFilename}" width="${chartData.width}" height="${chartData.height}" debugMode="false" registerWithJS="true" xmlUrl="${chartData.url}" renderer="javascript" windowMode="opaque"/>
<BR>
<BR>
	<%-- Now, create a Line Chart--%>
<fc:render chartId="${chartData.uniqueId}" swfFilename="${folderPath}${lineChart}" width="${chartData.width}" height="${chartData.height}" debugMode="false" registerWithJS="true" xmlUrl="${chartData.url}" renderer="javascript"/>
<BR>
<BR>
	<%-- Now, create a Area2D Chart --%>
<fc:render chartId="${chartData.uniqueId}" swfFilename="${folderPath}${areaChart}" width="${chartData.width}" height="${chartData.height}" debugMode="false" registerWithJS="true" xmlUrl="${chartData.url}" renderer="javascript"/>
</tags:template2>